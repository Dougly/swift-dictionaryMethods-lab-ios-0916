 ...
 */
// write your code here
var starWarsVillans = ["Darth Vader", "Emperor Palpatine"]
 ...
 */
// write your code here
for (index, character) in starWarsCharacters.keys.enumerate() {
 ...
 */
// write your code here
let numberOfKeys = starWarsCharacters.keys.count
print (numberOfKeys)
...
if starWarsCharacters.isEmpty {
    ...
    print ("There are \(numberOfKeys) items in the ditionary.")
}
// I expect to see 4 items in the dictionary
